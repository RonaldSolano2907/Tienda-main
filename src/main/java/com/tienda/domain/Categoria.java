...
public class Categoria implements Serializable { //serializacion porque se va almacenar ciertos datos en el disco
    ...
    //aca se hace la asociacion con la tabla de productos
    @OneToMany //categoria de uno a muchos
    @JoinColumn (name="id_categoria", updatable = false) //esta es la union con la tabla de productos el foreign key
